...
import { ArrowLeft, BarChart3, Users, Percent, Flame, CheckCircle2, XCircle, LogOut, Layers } from 'lucide-react';
...
export default async function AnalyticsPage() {
  ...
  const totalABImpressions = impressionsA + impressionsB;
  const totalABConversions = conversionsA + conversionsB;
  const abConversionRate = totalABImpressions > 0 ? (totalABConversions / totalABImpressions) * 100 : 0;

  // 3. Prepare Segment Data for Donut Chart
    ...
    <div className="relative min-h-screen w-full bg-[#080611] text-slate-100 font-sans pb-16">
      ...
      <main className="max-w-7xl mx-auto px-6 mt-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-[#100c24]/50 border border-purple-500/10 rounded-xl p-5 shadow-lg shadow-purple-950/5">
            <div className="flex justify-between items-start text-slate-400 mb-3">
              <span className="text-xs font-semibold uppercase tracking-wider">Avg Conversion Rate</span>
          ...
          <div className="bg-[#100c24]/50 border border-purple-500/10 rounded-xl p-5 shadow-lg shadow-purple-950/5">
            <div className="flex justify-between items-start text-slate-400 mb-3">
              <span className="text-xs font-semibold uppercase tracking-wider">A/B Winning Variant</span>
                ...
                {barChartSegments.map((segment, idx) => (
                  <div key={idx} className="space-y-2">
                    <div className="flex items-center justify-between text-xs">
                      <span className="font-semibold text-slate-300">{segment.name}</span>
